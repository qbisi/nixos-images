...
- Start minimal and grow by addition. Do not generate a comprehensive default skill and then subtract. Add only the rules, commands, or examples that are justified by the current context.
