...
buildUBoot rec {
  ...
  extraConfig = ''
    CONFIG_DEFAULT_DEVICE_TREE="rockchip/rk3399-bozz-sw799a-5g"
    CONFIG_DEFAULT_FDT_FILE="rockchip/rk3399-bozz-sw799a-5g.dtb"
    CONFIG_SYSINFO=y
    CONFIG_SYSINFO_SMBIOS=y
    CONFIG_SYSINFO_SMBIOS_MANUFACTURER="Bozz"
    CONFIG_SYSINFO_SMBIOS_PRODUCT="Bozz SW799A"
    CONFIG_SYSINFO_SMBIOS_VERSION="5G"
